...
class Protocol(p2protocol.Protocol):
    ...
    def handle_block(self, block):
        block_hash = bitcoin_data.skeinhash256(bitcoin_data.block_header_type.pack(block['header']))
    ...
    def handle_headers(self, headers):
        for header in headers:
            ...
            self.get_block_header.got_response(bitcoin_data.skeinhash256(bitcoin_data.block_header_type.pack(header)), header)
